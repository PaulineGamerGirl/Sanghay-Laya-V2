export interface TransmascThriftSpot {
  id: string;
  name: string;
...
export const transmascThriftSpots: TransmascThriftSpot[] = [
  {
    id: '1',
    ...
    walkTime: '3 mins',
    price: '₱',
    target: 'Graphic Tees, Oversized Polos',
  ...
  },
  {
    ...
    walkTime: '10 mins',
    price: '₱₱',
    target: 'Vintage Blazers, Leather Jackets',
  ...
  },
  {
    ...
    walkTime: '1 min',
    price: '₱ - ₱₱',
    target: 'Cargo Pants, Flannels, Hoodies',
  ...
  },
  {
    ...
    walkTime: '3 mins',
    price: '₱',
    target: 'Button-downs, Straight-cut Pants',
    directions: '"Just along Boni Ave right after you go down the MRT station. It gets overlooked, but it is a fantastic hidden spot for casual menswear."',
    badge: 'HIDDEN GEM',
  ...
  },
  {
    ...
    walkTime: '2 mins',
    price: '₱',
    target: 'Streetwear, Sneakers, Caps',
